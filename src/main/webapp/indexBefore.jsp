        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/list2?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/course/list2?subjectId=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/list2?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/list2?subjectId=11">
