    ...
    <menu>
        <div class="container clearfix">
            <ul class="clearfix f_left">
                <li><a href="${pageContext.request.contextPath}/indexBefore.jsp">首页</a></li>
                <li><a href="${pageContext.request.contextPath}/index.jsp">课程</a></li>
                <li><a href="#">关于我们</a></li>
                <li class="menu_active"><a href="${pageContext.request.contextPath}/user/showMyProfile">个人中心</a>
                </li>
            </ul>
            <div id="search_group">
            ...
            <div id="user_bar">
                ...
                <a href="${pageContext.request.contextPath}/user/logout?urlAddress=" id="lay_out">退出</a>
            </div>
        </div>
    </menu>
</header>
                    ...
                    <div class="profile_ifo_area">
                        <form>
                            ...
                            <div class="form_group">
                                ...
                                <input type="password" id="newPassword02" name="newPassword2"><span id="passMsg"></span>
                            </div>
    ...
    $("form").submit(function () {
        $.ajax({
            ...
            success:function (data) {
                if (data.code == 1) {
                    alert("修改成功！");
                    window.location.href = "showMyProfile";
                } else {
                    alert(data.info);
                }
            }
